...
An application using @LinhPhan9605/h5p-server can customize the way H5P behaves in
several ways:
...
@LinhPhan9605/h5p-server allows you to pass two hooks in the options of the
