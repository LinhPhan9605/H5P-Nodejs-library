...
```sh
$ npm install @LinhPhan9605/h5p-react
```

Then, import the component in your JavaScript / TypeScript code:

```js
import { H5PPlayerUI, H5PEditorUI } from '@LinhPhan9605/h5p-react';
```
...
If you use @LinhPhan9605/h5p-server you will get the necessary information by
